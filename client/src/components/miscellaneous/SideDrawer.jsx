...
import { getSender } from "../../config/ChatLogics"; // 👈 Import this for notification names
...
const SideDrawer = () => {
  ...
  const accessChat = async (userid) => {
    try {
      ...
      // ⚡ FIX: Sending 'userId' (CamelCase) to match standard backend expectations
